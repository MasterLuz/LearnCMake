...
int main(){
	...
	std::cout << "C++ compiler name: " << CXX_COMPILER_NAME << std::endl;
	std::cout << "Architecture name: " << ARCHITECTURE << std::endl;
	...
	std::cout << "Processor supports 3DNNOW instructions: " << HAS_AMD_3DNOW << std::endl;
